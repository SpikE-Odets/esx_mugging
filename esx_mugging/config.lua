...
Config.AddItemsPerctent = 80        --  This is percent the script will add items as well as cash from mugging.
Config.AddItemsMax = 3              --  This is the max number of items you can receive from NPC from mugging - min is 1

Config.PoliceNotify = 90            --  This is percent the police will get notified: example: 40 means 40% chance of notification.
